...
const ButtonBorderGradient = memo(
    ({ buttonText, onClick, outsideClassName, insideClassName, isDisabled, buttonType = "button" }: { buttonText: string; onClick?: any | void; outsideClassName?: string | void; insideClassName?: string | void; isDisabled: boolean; buttonType: "button" | "submit" }) => (
        <div
            onClick={onClick}
