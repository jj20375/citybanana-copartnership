    ...
    const RenderTitle = () => (
        <div className=" mb-[40px] font-bold">
            <Image
                ...
                className="mx-auto"
            />
            <h1 className="text-black w-full text-md-title text-center mt-[30px]">{t("orderDetail.title-cancel")}</h1>
        </div>
    );
    ...
    const RenderButton = () => (
        <div className="flex flex-col">
            <ButtonBorderGradient
                onClick={onSubmit}
                buttonText={t("orderCancel.button-uncareful") + ` (${seconds})`}
