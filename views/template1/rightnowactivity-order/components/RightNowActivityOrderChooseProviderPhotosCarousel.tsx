 ...
 * @returns
 */
export const CarouselByProviderPhotoItem = ({ isSnapPoint, children }: CarouselItemProps) => <li className={`${isSnapPoint && "snap-start"} w-full shrink-0 h-auto snap-normal`}>{children}</li>;
