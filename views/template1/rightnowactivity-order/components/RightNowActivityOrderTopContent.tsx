...
const RightNowActivityOrderTopContent = memo(({ lng, values, setValues, customClass }: { lng: string; values?: { label: string; value: string; column: string }[] | void; setValues?: Function | void; customClass?: string | void }) => {
