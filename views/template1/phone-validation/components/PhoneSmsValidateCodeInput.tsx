...
const PhoneSmsValidateCodeInput = memo(
    ({ lng, register, label, value, setValue, className, isDisabled }: { lng: string; register: UseFormRegister<PhoneValidationInterface>; label: Path<PhoneValidationInterface>; value: string; setValue: Function; className?: string | void; isDisabled: boolean }) => {
